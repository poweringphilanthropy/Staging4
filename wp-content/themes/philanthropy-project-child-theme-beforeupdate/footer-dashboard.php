...
$support_email = get_post_meta( $post->ID, '_support_email', true );
?>
        </div><!-- #main -->
    </div><!-- .body-wrapper -->
</div><!-- #page -->
...
$get_started_page = get_term_meta( $leaderboard->get_term_id(), '_dashboard_get_started_page', true );
                    ...
                    <div class="menu-footer-container">
                        <ul class="menu" id="menu-footer" style="text-transform: uppercase;">
                            ...
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7438" id="menu-item-7438">
                                <a href="<?php echo get_permalink( $get_started_page ); ?>"><?php _e('Get Started', 'pp-toolkit'); ?></a>
                            </li>
                            <?php endif; ?>
                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7438" id="menu-item-7438">
