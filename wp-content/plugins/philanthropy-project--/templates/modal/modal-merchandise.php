							...
							if ( $variable_pricing ) {
								...
								<tr data-download-id="<?php echo $download->ID; ?>" data-variable-key="<?php echo $variable_key; ?>">
									...
									<td data-label="Quantity">
										<input data-product-id="<?php echo $download->ID; ?>" data-variable-key="<?php echo $variable_key; ?>" name="merchandise[<?php echo $download->ID; ?>][variation][<?php echo $variable_key; ?>][qty]" class="product_qty" type="number" min="0" value="0">
									</td>
								</tr>
								<?php
								}
