...
(function ( window, document, $, my ) {
	...
	my.render_fields = function( ticket_id, num, field ) {
		var $row = field.closest('table').find( '.tribe-event-tickets-plus-meta' ).filter( '[data-ticket-id="' + ticket_id + '"]' );
	...
	my.set_quantity = function( $field ) {
		...
		my.render_fields( ticket_id, quantity, $field );
	};
