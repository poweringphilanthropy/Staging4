...
<div id="server-scheduler-settings">
	...
	<div class="tile">
		...
		<h3 class="tile-header"><?php _e( 'Server Scheduler', 'advanced-cron-manager' ); ?></h3>
		...
		<div class="tile-content">
			...
			<form id="server-settings-form">
				...
				<div class="dependants" <?php echo $display_dependants; ?>>
					...
					<p>
						...
						<code>wget -qO- <?php echo site_url( '/wp-cron.php' ); ?> &> /dev/null</code>
					</p>
